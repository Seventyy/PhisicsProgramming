...
namespace GXPEngine
{
	...
	public class Transformable
	{
		...
		/// The y coordinate.
		/// </param>
		public virtual Core.Vector2 InverseTransformPoint (float x, float y)
		{
            Core.Vector2 ret = new Core.Vector2 ();
			x -= _matrix [12];
			y -= _matrix [13];
		...
		/// </summary>
		public virtual Core.Vector2 InverseTransformDirection (float x, float y)
		{
            Core.Vector2 ret = new Core.Vector2 ();
			if (_scaleX != 0) ret.x = ((x * _matrix[0] + y * _matrix[1]) / _scaleX); else ret.x = 0;
			if (_scaleY != 0) ret.y = ((x * _matrix[4] + y * _matrix[5]) / _scaleY); else ret.y = 0;
		...
		/// The y coordinate.
		/// </param>
		public virtual Core.Vector2 TransformPoint(float x, float y) {
            Core.Vector2 ret = new Core.Vector2();
		...
		/// This means that rotation and scaling is applied, but translation is not.
		/// </summary>
		public virtual Core.Vector2 TransformDirection(float x, float y) {
            Core.Vector2 ret = new Core.Vector2();
